				...
				<p style="text-align:right;">Përshëndetje, <em><?php  echo $kontrollo_perdorues;?>!</em></p>
					...
					<section>
						...
						<table>
							...
							<tr>
								<td>Shkruaj:</td>
								<td><input type="text" name="kusht" placeholder="Titulli i të dhënave ose Pamja e faqes"/></td>
					...
					<section>
						...
						<thead>
							<tr>
								<th>Titulli i te dhënave</th>
								<th>Përshkrimi i te dhënave</th>
								<th>Fajlli</th>
								<th>Pamja e faqes</th>
								<th>Modifiko</th>
							</tr>
							...
							<tbody>
								...
								while($rreshti = mysqli_fetch_array($sql)) { 		
										...
										echo "<td><a href=\"forma_modifikoteDhena.php?ID_tedhenat=$rreshti[ID_tedhenat]\" class='button primary'>
										Modifiko</a></td></tr>";		
									}
