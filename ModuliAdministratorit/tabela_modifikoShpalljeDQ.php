				...
				<p style="text-align:right;">Përshëndetje, <em><?php  echo $kontrollo_perdorues;?>!</em></p>
					...
					<section>
						...
						<div class="table-wrapper">
							<table>
								<tr>
									<h3>Kërko të dhënat e shpalljes së dërguar për modifikim</h3>
								</tr>
								<tr>
									<td>Shkruaj:</td>
									<td><input type="text" name="kusht" placeholder="Titullin ose emri i dërguesit"/></td>
						...
						<thead>
							...
							<tbody>
								...
								while($rreshti = mysqli_fetch_array($sql)) { 		
										...
										echo "<td><a href=\"modifiko_shpalljeDQ.php?ID_shpalljaD=$rreshti[ID_shpalljaD]\" class='button primary'>
										Modifiko</a></td></tr>";		
									}
