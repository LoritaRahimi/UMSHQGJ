			...
			<div id="page-wrapper">
				...
				<article id="main">
						<section class="wrapper style5">
							...
							<table>
								<tr><h3>Kërko të dhënat e përdoruesit për fshirje</h3></tr>
								<tr>
								<td>Shkruaj:</td>
							...
							if(!empty($_REQUEST['kusht'])) {
								...
								while($rreshti=mysqli_fetch_array($sql)){
									...
									echo"<td><a href=\"fshij_perdorues.php?ID_perdoruesi=$rreshti[ID_perdoruesi]\" onClick=\"return confirm ('A jeni të sigurtë se dëshironi të fshini përdoruesin?')\"
									class='button primary'>Fshij</a></td></tr>";
								}
							}?>	
							</tbody>							
								</div>
