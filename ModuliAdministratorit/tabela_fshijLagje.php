...
"SELECT * FROM umshqgj_lagjet ORDER BY ID_Lagjja DESC");
?>
<!DOCTYPE HTML>
<!--
			...
			<div id="page-wrapper">
				...
				<article id="main">
						...
						<p style="text-align:right;">Përshëndetje, <em><?php  echo $kontrollo_perdorues;?>!</em></p>
								...
								<table>
									<tr><h3>Kërko emrin e lagjes për fshirje</h3></tr>
									<tr>
										<td>Shkruaj:</td>
										<td><input type="text" name="kusht" placeholder="Emrin e lagjes"/></td>
							...
							<?php
								...
								while($rreshti = mysqli_fetch_array($sql)) { 		
										...
										echo "<td><a href=\"fshij_lagje.php?ID_Lagjja=$rreshti[ID_Lagjja]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini lagjen?')\" class='button primary'>Fshij</a>
										</td></tr>";		
									}
