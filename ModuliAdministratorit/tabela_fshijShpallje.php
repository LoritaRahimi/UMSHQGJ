			...
			<div id="page-wrapper">
				...
				<p style="text-align:right;">Përshëndetje, <em><?php  echo $kontrollo_perdorues;?>!</em></p>
					...
					<div class="table-wrapper">
						<table>
							<tr>
								<h3>Kërko të dhënat e shpalljes për modifikim</h3>
							</tr>
							<tr>
								<td>Shkruaj:</td>
								<td><input type="text" name="kusht" placeholder="Titulli ose Çmimi "/></td>
								...
								WHERE
								  umshqgj_shpalljet.Titulli LIKE '%".$kusht."%' OR umshqgj_shpalljet.Çmimi LIKE '%".$kusht."%'"
									...
									while($rreshti = mysqli_fetch_array($sql)) { 		
											...
											echo "<td><a href=\"fshij_shpallje.php?ID_shpallja=$rreshti[ID_shpallja]\" onClick=\"return confirm('A jeni të sigurtë se dëshironi të fshini të dhënen?')\"  class='button primary'>Fshij</a> </td>";			
										}
